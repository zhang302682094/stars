...
CREATE TABLE `activity`  (
  ...
  CONSTRAINT `activity` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of activity
-- ----------------------------
INSERT INTO `activity` VALUES (1, 1, '学校1', '方案1', '2020-07-01 00:00:00', '物料1', '人员安排1', '宣传1', '反馈1', '签到1', 30, 10, '嘉年华', '照片1');
INSERT INTO `activity` VALUES (2, 2, '学校2', '方案2', '2020-07-02 00:00:00', '物料2', '人员安排2', '宣传2', '反馈2', '签到2', 31, 11, '嘉年华', '照片2');
INSERT INTO `activity` VALUES (3, 3, '学校3', '方案3', '2020-07-03 00:00:00', '物料3', '人员安排3', '宣传3', '反馈3', '签到3', 32, 12, '嘉年华', '照片3');
INSERT INTO `activity` VALUES (4, 4, '学校4', '方案4', '2020-07-04 00:00:00', '物料4', '人员安排4', '宣传4', '反馈4', '签到4', 33, 13, '教师培训', '照片4');
INSERT INTO `activity` VALUES (5, 5, '学校5', '方案5', '2020-07-05 00:00:00', '物料5', '人员安排5', '宣传5', '反馈5', '签到5', 34, 14, '教师培训', '照片5');
INSERT INTO `activity` VALUES (6, 6, '学校6', '方案6', '2020-07-06 00:00:00', '物料6', '人员安排6', '宣传6', '反馈6', '签到6', 35, 15, '家长培训', '照片6');
INSERT INTO `activity` VALUES (7, 7, '学校7', '方案7', '2020-07-07 00:00:00', '物料7', '人员安排7', '宣传7', '反馈7', '签到7', 36, 16, '家长培训', '照片7');
INSERT INTO `activity` VALUES (8, 8, '学校8', '方案8', '2020-07-08 00:00:00', '物料8', '人员安排8', '宣传8', '反馈8', '签到8', 37, 17, '形式4', '照片8');
INSERT INTO `activity` VALUES (9, 9, '学校9', '方案9', '2020-07-09 00:00:00', '物料9', '人员安排9', '宣传9', '反馈9', '签到9', 38, 18, '形式5', '照片9');
INSERT INTO `activity` VALUES (10, 10, '学校10', '方案10', '2020-07-10 00:00:00', '物料10', '人员安排10', '宣传10', '反馈10', '签到10', 39, 19, '家长培训', '照片10');
INSERT INTO `activity` VALUES (11, 1, '学校1', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `activity` VALUES (12, 11, '学校11', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `book`  (
  ...
  `rotation_times` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `book` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (1, 1, '学校1', '20', '0.05', '5', '使用记录1', '捐赠1', '反馈', NULL, '1班', '2班');
INSERT INTO `book` VALUES (2, 2, '学校1', '30', '0.1', '4', '使用记录2', '捐赠2', '反馈', NULL, '2班', '3班');
INSERT INTO `book` VALUES (3, 3, '学校1', '25', '0.2', '3', '使用记录2', '捐赠2', NULL, NULL, NULL, NULL);
...
-- ----------------------------
-- Records of children_research
-- ----------------------------
INSERT INTO `children_research` VALUES (1, 10, '书面调研', '计划1', '内容1');
...
CREATE TABLE `class`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `class`(`s_id`) USING BTREE,
  CONSTRAINT `class` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES (1, 1, '学校1', '3', '4', 20, '1', 10, '每天', NULL, '3天一次', '40分钟', '每天一次', '1小时', '每天一次', '40分钟', '每天两次', 10, '语文');
INSERT INTO `class` VALUES (2, 2, '学校2', '2', '2', 30, '1', 20, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `coorperation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `coorperation`(`s_id`) USING BTREE,
  CONSTRAINT `coorperation` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of coorperation
-- ----------------------------
INSERT INTO `coorperation` VALUES (1, 1, '学校1', '资源1', '意愿1', '需求1', '项目名称1', '项目周期');
...
CREATE TABLE `library`  (
  ...
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `library`(`s_id`) USING BTREE,
  CONSTRAINT `library` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of library
-- ----------------------------
INSERT INTO `library` VALUES (1, 1, '学校1', '300平方米', 200, '0.8', '管理员', '1', '1', '0', NULL);
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES (1, '项目1', '某某幼儿园', '1年');
...
-- Records of punch
-- ----------------------------
INSERT INTO `punch` VALUES (1, '学校1', '内容1', 15, '测试内容1', 10, 140, '奖品1', 3);
INSERT INTO `punch` VALUES (2, '学校1', NULL, 10, NULL, 20, 180, NULL, 5);
INSERT INTO `punch` VALUES (3, '学校2', NULL, 20, NULL, 30, 560, NULL, 10);
...
-- Records of school
-- ----------------------------
INSERT INTO `school` VALUES (1, '鲁冰花幼儿园', '贵都路丰顺路645号76号', NULL, 8, 19, 364, NULL, '姚冲锋', 'yq709860925', NULL, NULL, NULL);
INSERT INTO `school` VALUES (2, '中河幼儿园', '浦江镇芦胜村四组河桥西侧', NULL, 10, 20, 339, NULL, '吴从玲', '13764980127', NULL, NULL, NULL);
INSERT INTO `school` VALUES (3, '小博士幼儿园', '吴北路66号', NULL, 14, 24, 490, NULL, '史勤伟', '13816442269', NULL, NULL, NULL);
INSERT INTO `school` VALUES (4, '南塘幼儿园', '吴泾镇龙吴路4988号', NULL, 10, 33, 339, NULL, '鲍红娟', '13524062176', NULL, NULL, '(不合作）');
INSERT INTO `school` VALUES (5, '文博幼儿园', '浦江镇勤劳村苏召路1699号', NULL, 12, 12, 424, NULL, '彭雅玲', '18202162757', '主任', NULL, NULL);
INSERT INTO `school` VALUES (6, '苏民幼儿园', '浦江镇陈行公路1128号', NULL, 12, 24, 430, NULL, '来志荣\n', '18017721939', NULL, NULL, NULL);
INSERT INTO `school` VALUES (7, '召楼幼儿园', '沈杜路128号', NULL, 15, 30, 556, NULL, '何琴', '13636690102', NULL, NULL, NULL);
INSERT INTO `school` VALUES (8, '世纪幼儿园', '曹行金都路金都路810号', NULL, 22, 23, 856, NULL, '冯莉', '13901874001', NULL, NULL, NULL);
INSERT INTO `school` VALUES (9, '丑小鸭幼儿园', '虹梅南路3509弄8号', NULL, 12, 25, 448, NULL, '杨佳', '15021056729', NULL, NULL, NULL);
INSERT INTO `school` VALUES (10, '叮叮幼儿园', '七宝镇航中路618号', NULL, 12, 18, 460, NULL, '楼园', '13917828225', NULL, NULL, NULL);
INSERT INTO `school` VALUES (11, '博苑幼儿园', '北翟路4855号', NULL, 12, 25, 420, NULL, '张雅君\n沈老师 ', '13681933501\n13482287764', '园长助理', NULL, NULL);
INSERT INTO `school` VALUES (12, '红卫幼儿园', '华漕镇纪翟路2791号', NULL, 15, 39, 452, NULL, '沈腊梅', '18930671785', NULL, NULL, NULL);
INSERT INTO `school` VALUES (13, '银露幼儿园', '华漕镇纪鹤路1号', NULL, 8, 18, 219, NULL, '荆春荣', '13636339813', NULL, NULL, '（年底拆)');
INSERT INTO `school` VALUES (14, '梦哆啦幼儿园', '华腾公路与纪鹤公路交叉口北100米', NULL, 17, 24, 409, NULL, '刘园长', '60712118', NULL, NULL, NULL);
INSERT INTO `school` VALUES (15, '航隆幼儿园', '华漕镇纪翟路2788号', NULL, 14, 14, 582, NULL, '柏桂香,聂老师', '13816914942,\n18516037939', '园长,保教主任', NULL, NULL);
INSERT INTO `school` VALUES (16, '喜洋洋幼儿园', '华漕镇纪丰路99号', NULL, 10, 20, 298, NULL, '杨芝', '13601991229', NULL, NULL, '（已拆）');
INSERT INTO `school` VALUES (17, '花朵幼儿园', '浦宁路88号', NULL, 10, 20, 380, NULL, '刘琴', '13761303679', NULL, NULL, NULL);
INSERT INTO `school` VALUES (18, '贝蓓幼儿园', '吴泾镇龙吴路5411号', NULL, 14, 30, 529, NULL, '余鸿萍', '18964347335', '导教主任', NULL, NULL);
INSERT INTO `school` VALUES (19, '爱嘉幼儿园', '浦江镇永颂440号', NULL, 13, 33, 546, NULL, '吴亚楠', '54849986,\n15800868104', '吴园长的女儿', NULL, NULL);
INSERT INTO `school` VALUES (20, '皖苏幼儿园', '江川路1800号', NULL, 11, 17, 377, NULL, '唐芙蓉', '15821305283', NULL, NULL, NULL);
INSERT INTO `school` VALUES (21, '行南幼儿园', '老沪闵路1488号', NULL, 12, 19, 470, NULL, '季巧', '15821152030', NULL, NULL, NULL);
INSERT INTO `school` VALUES (22, '华宁路幼儿园', '华宁路40号', NULL, 12, 24, 324, NULL, '施建珍', '18918025926', NULL, NULL, NULL);
INSERT INTO `school` VALUES (23, '莘庄金贝贝幼儿园', '莘沥路551号', NULL, 12, 24, 374, NULL, '何志贤', '13764598057', NULL, NULL, NULL);
INSERT INTO `school` VALUES (24, '宝华幼儿园', '闵行区吴中路2625号', NULL, 7, 14, 234, NULL, '朋菊萍', '13818549422', NULL, NULL, '(已关闭）');
INSERT INTO `school` VALUES (25, '华漕希望幼儿园', '南华街45号', NULL, 12, 12, 480, NULL, '岳风英', '021-52210672 ', NULL, NULL, '（不合作）');
INSERT INTO `school` VALUES (26, '春苗幼儿园', '华漕红卫村孙家宅58号', NULL, 7, 9, 245, NULL, '徐艳华', '13012851234', NULL, NULL, NULL);
INSERT INTO `school` VALUES (27, '碧城联明幼儿园', '中春路7155弄68支弄', NULL, 11, 22, 339, NULL, '柳建珍', '13916026086', NULL, NULL, NULL);
INSERT INTO `school` VALUES (28, '东兰路幼儿园', '龙茗路1706号301室', NULL, 7, 10, 175, NULL, '周红花', '13761873538', NULL, NULL, NULL);
INSERT INTO `school` VALUES (29, '嘉臣金宝贝幼儿园', '东兰路228号-10号', NULL, 10, 22, 380, NULL, '张梨萍', '18301704623', NULL, NULL, '（有需要再打电话给我们）');
INSERT INTO `school` VALUES (30, '金盛幼儿园', '都庄路4226号4栋', NULL, 10, 12, 247, NULL, '周红花', '13761873538', NULL, NULL, NULL);
INSERT INTO `school` VALUES (31, '沪川幼儿园', '虹中路115号1号楼3楼', NULL, 14, 26, 468, NULL, '翰咏梅', '13917694106', NULL, NULL, NULL);
INSERT INTO `school` VALUES (32, '吴泾贝儿幼儿园', NULL, NULL, NULL, NULL, NULL, NULL, '陈雷', '15216700374', NULL, NULL, '（请示董事长）');
...
CREATE TABLE `student`  (
  ...
  `join_survey` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `s_id` int(0) NULL DEFAULT NULL,
  `class` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  INDEX `student`(`s_id`) USING BTREE,
  CONSTRAINT `student` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('张三', '1', 1, NULL);
INSERT INTO `student` VALUES ('李四', '1', 1, NULL);
...
CREATE TABLE `survey`  (
  ...
  `s_id` int(0) NULL DEFAULT NULL,
  `school_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `serve_people` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `form` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `survey`(`s_id`) USING BTREE,
  CONSTRAINT `survey` FOREIGN KEY (`s_id`) REFERENCES `school` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of survey
-- ----------------------------
INSERT INTO `survey` VALUES (1, 1, '学校1', '', NULL, NULL, NULL, NULL);
INSERT INTO `survey` VALUES (2, 2, '学校2', NULL, NULL, NULL, NULL, NULL);
...
-- Records of visit
-- ----------------------------
INSERT INTO `visit` VALUES (1, '2020-05-21 17:52:47', '1', '人员1', 10, '对接人员1', '走访内容1', '1', '文档1');
INSERT INTO `visit` VALUES (2, '2020-05-21 17:54:38', '2', '人员1', 20, '对接人员2', '走访内容1', '0', '文档2');
